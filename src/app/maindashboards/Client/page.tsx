...
export default function ClientDashboard({ children }: { children?: React.ReactNode }) {
  ...
  const isMenuItemActive = (itemPath: string) => {
    if (itemPath === "/client/dashboard" && pathname === "/client/dashboard") {
      return true;
    }
    return pathname?.startsWith(itemPath) && itemPath !== "/client/dashboard";
  };
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-emerald-50 via-cyan-50 to-blue-50 text-gray-900">
      {/* Fixed Sidebar */}
      <aside className="w-64 bg-white/95 shadow-xl border-r border-gray-200 backdrop-blur-md flex flex-col fixed h-full">
